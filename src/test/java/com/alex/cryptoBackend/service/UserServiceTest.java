...
import static com.alex.cryptoBackend.exception.code.AlertCode.USER_NOT_EXISTS;
...
class UserServiceTest {
    ...
    private final long expiredMinutes = 20L;
    ...
    private List<UserDto> allUserDtos = new ArrayList<>();
